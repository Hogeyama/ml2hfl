...
linear arithmetic is decidable. \todo{add an example}
...
function in the original program.  \todo{add an example}  The constraint 
...
\right.
\end{eqnarray*}
\todo{explain why it works better in most cases}  We thus compute 
