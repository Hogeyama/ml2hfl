...
approach. Among others, we introduce (i) selective predicate
abstraction, (ii) generalize predicate discovery, (iii) selective CPS
transformation as optimization techniques, and (iv) functional encoding
of recursive data structures and control operations to support a larger
