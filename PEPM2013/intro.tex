...
In this paper, we address four problems of our previous work.
...
\end{figure}
      ...
      To discover general predicates, we introduce a novel predicate
      discovery method for higher-order functional programs.  The method
      reduces the number of false errors produced by predicate
      abstraction. By considering information from multiple calling
      contexts in multiple paths, the method discovers predicates that
      are useful in multiple call-sites of a function, and also
      discovers predicates to verify path- and context-sensitive
      conditions.
