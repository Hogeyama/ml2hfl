...
Note that the column of ``C. \& A. \& D.'' is evaluated using the
refined predicate discovery that uses only a single infeasible error
...
$\mathtt{r}$ argement of \texttt{length\_aux}.  Actually, we verified
