...
\end{eqnarray*}
Thus, a continuation should be inserted only for functions of type
$\TFunC{\tau_1}{\tau_2}$, not for functions of type $\TFunN{\tau_1}{\tau_2}$.
...
In (a), there is no need to insert a continuation parameter after $x$.
