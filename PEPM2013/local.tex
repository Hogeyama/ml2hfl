...
\newcommand\Redwith[2]{\stackrel{#1}{\rightarrow}_{#2}}
...
\newcommand\CPScolon[6]{{#1} \p {#2} \COL {#3}, {#4} \COL {#5} \leadsto {#6}}
...
\newcommand\AbstT[4]{{#1} \vdash {#2} : {#3} \hookrightarrow {#4}}
...
\newcommand\ToC[1]{\mathbf{ToC}(#1)}
\newcommand\ElimAnnot[1]{\mathtt{Elim}(#1)}
\newcommand\hole{[]}
