...
(* $Id: solve.ml,v 1.5 2011-08-08 19:31:17 weis Exp $ *)

(** {3 The constraint saturation procedure for the Sudoku problem} *)

(** We recursively sature the board: as soon as we found something
   new, we start again from the beginning to go on saturing the board.
   There should be room for improvement here! *)

(** {6 Auxilliaries to manipulate the contents} *)

(** We define some list functions to manipulate the lists that are the
    contents of elements of the board. *)
