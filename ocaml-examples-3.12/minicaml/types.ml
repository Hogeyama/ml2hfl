...
(* $Id: types.ml,v 1.4 2011-08-08 19:31:17 weis Exp $ *)
...
let rec valeur_de = function
  | Variable ({valeur = Connue ty1; niveau = _; } as var) ->
      let valeur_de_ty1 = valeur_de ty1 in
      var.valeur <- Connue valeur_de_ty1;
      valeur_de_ty1
  | Variable {valeur = Inconnue; niveau = _; }
  | Terme _ as ty -> ty
;;
...
let test_d'occurrence var ty =
  let rec test t =
    ...
    | Terme (_constructeur, arguments) ->
        Array.iter test arguments in
  test ty
;;
