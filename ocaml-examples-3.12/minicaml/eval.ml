...
(* $Id: eval.ml,v 1.3 2011-08-08 19:31:17 weis Exp $ *)
...
and évalue_définition env_courant déf =
  ...
  | true ->
      ...
      | Fonction liste_de_cas ->
          ...
          env_étendu
      | Booléen _ | Nombre _ | Paire (_, _)
      | Nil | Cons (_, _)
      | Let (_, _) | Application (_, _) | Variable _ ->
          raise (Erreur "let rec non fonctionnel")
;;
