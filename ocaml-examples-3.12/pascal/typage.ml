...
(* $Id: typage.ml,v 1.3 2011-08-08 19:31:17 weis Exp $ *)
...
type erreur_de_type =
  ...
  | Indéfini of string
    (* Conflit de types *)
  | Conflit of string * expr_type * expr_type
    (* Mauvais nombre d'arguments *)
  | Arité of string * int * int
    (* [..] appliqué à un non-tableau *)
  | Tableau_attendu
    (* tableau renvoyé en résultat *)
  | Tableau_interdit of string
;;
...
let type_procédure env_global (_nom, décl) =
  let env =
