...
(* $Id: syntaxe.ml,v 1.3 2011-08-08 19:31:17 weis Exp $ *)
...
type expr_type =
  ...
  | Boolean
    (* le type des tableaux (les deux "int" sont les bornes) *)
  | Array of int * int * expr_type
;;
...
let lire_prog = parser
    [< 'MC "program"; 'Ident _nom_du_programme; 'MC ";";
