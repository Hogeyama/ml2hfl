...
val check : (CEGAR_syntax.var * CEGAR_syntax.t CEGAR_type.t) list -> CEGAR_syntax.t list -> CEGAR_syntax.t -> bool
(** [check cond t] で，[cond] |= [t] かどうかを調べる *)

val checksat : (CEGAR_syntax.var * CEGAR_syntax.t CEGAR_type.t) list -> CEGAR_syntax.t -> bool
