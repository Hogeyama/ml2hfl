let rec map (x_DO_NOT_CARE_180:bool) (x_DO_NOT_CARE_181:int)
  ...
  if prev_set_flag_map_139
  then
    if s_prev_map_xs_138 > xs && xs >= 0 then () else assert false;
  map_without_checking_175
    x_DO_NOT_CARE_180 x_DO_NOT_CARE_181 x_DO_NOT_CARE_182
    f_EXPARAM_127 x_DO_NOT_CARE_177 x_DO_NOT_CARE_178
    x_DO_NOT_CARE_179 f prev_set_flag_map_139
    s_prev_map_f_EXPARAM_136 s_prev_map_xs_138 xs
and map_without_checking_175 (_:bool) (_:int) (_:int)
                            (f_EXPARAM_127:int) (_:bool) (_:int)
                            (_:int)
...
let compose (_:bool) (_:int) (_:int) (_:int) (_:bool) (_:int) (_:int)
           ...
           (set_flag_map_140:bool) (s_map_f_EXPARAM_133:int)
           (s_map_xs_135:int) (x:int) =
  f
    set_flag_map_140 s_map_f_EXPARAM_133 s_map_xs_135
