...
let rec f (set_flag_id_83:bool) (x:int) =
  ...
  then
    ...
    id
let main (set_flag_id_83:bool) (():unit) =
  f set_flag_id_83 (Random.int 0) set_flag_id_83 ()
let u_395 = main false ()
