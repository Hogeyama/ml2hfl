...
and f2_without_checking_436 (_:bool) (_:int) (_:int) (u:unit) (_:bool)
  ...
  let set_flag_f2_391 = true
  in
  let s_f2_b_EXPARAM_383 = b_EXPARAM_271
  in
  let s_f2_a_EXPARAM_381 = a_EXPARAM_268
  in
  a
