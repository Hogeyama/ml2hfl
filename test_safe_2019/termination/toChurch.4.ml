...
let rec toChurch (x_DO_NOT_CARE_381:bool) (x_DO_NOT_CARE_382:int)
  ...
  if prev_set_flag_toChurch_361 then assert false;
  toChurch_without_checking_376
    x_DO_NOT_CARE_381 x_DO_NOT_CARE_382 x_DO_NOT_CARE_383 n
    x_DO_NOT_CARE_378 x_DO_NOT_CARE_379 x_DO_NOT_CARE_380 f_EXPARAM_116
    prev_set_flag_toChurch_361 s_prev_toChurch_n_358
...
and toChurch_without_checking_376 (_:bool) (_:int) (_:int) (n:int)
  ...
  then
    ...
    compose
      ...
      s_toChurch_n_355 s_toChurch_f_EXPARAM_356 f set_flag_toChurch_362
      s_toChurch_n_355 s_toChurch_f_EXPARAM_356
      (0 * f_EXPARAM_116 + (0 * n + 0)) set_flag_toChurch_362
      s_toChurch_n_355 s_toChurch_f_EXPARAM_356
      (toChurch_without_checking_376
        set_flag_toChurch_362 s_toChurch_n_355 s_toChurch_f_EXPARAM_356
        (n - 1) set_flag_toChurch_362 s_toChurch_n_355
        s_toChurch_f_EXPARAM_356 (0 * f_EXPARAM_116 + (0 * n + 0))
        set_flag_toChurch_362 s_toChurch_n_355 s_toChurch_f_EXPARAM_356 
        f)
  ...
  (if x >= 0
   then
     let tos =
       toChurch
         set_flag_toChurch_362 s_toChurch_n_355 s_toChurch_f_EXPARAM_356
         x set_flag_toChurch_362 s_toChurch_n_355
         s_toChurch_f_EXPARAM_356 (0 * x + (0 * x + 0))
         set_flag_toChurch_362 s_toChurch_n_355 s_toChurch_f_EXPARAM_356
         succ
     in
     ())
let u_10488 = main false 0 0 ()
