...
and app_without_checking_158 (_:bool) (_:int) (_:int) (_:int) (i:int)
  ...
  let set_flag_app_130 = true
  in
  let s_app_v_122 = v
  in
  let s_app_h_EXPARAM_120 = h_EXPARAM_112
  in
  let s_app_i_119 = i
  in
  if i >= 0
...
let rec f (set_flag_app_130:bool) (s_app_i_119:int)
         (s_app_h_EXPARAM_120:int) (s_app_v_122:int) (x:int) =
  if x > 0
  then
    app
      set_flag_app_130 s_app_i_119 s_app_h_EXPARAM_120 s_app_v_122
...
let main (set_flag_app_130:bool) (s_app_i_119:int)
        (s_app_h_EXPARAM_120:int) (s_app_v_122:int) (():unit) =
  f
    set_flag_app_130 s_app_i_119 s_app_h_EXPARAM_120 s_app_v_122
    (Random.int 0) set_flag_app_130 s_app_i_119 s_app_h_EXPARAM_120
    s_app_v_122 ()
let u_8187 = main false 0 0 0 ()
