...
let rec app (x_DO_NOT_CARE_171:bool) (x_DO_NOT_CARE_172:int)
  ...
  then
    if
      (7 + s_prev_app_h_EXPARAM_124) + 3 * s_prev_app_v_126 >
      (7 + h_EXPARAM_111) + 3 * v && (7 + h_EXPARAM_111) + 3 * v >= 0 ||
      (7 + s_prev_app_h_EXPARAM_124) + 3 * s_prev_app_v_126 >=
      (7 + h_EXPARAM_111) + 3 * v &&
      (((-5) + -s_prev_app_h_EXPARAM_124) + s_prev_app_v_126 >
       ((-5) + -h_EXPARAM_111) + v && ((-5) + -h_EXPARAM_111) + v >= 0)
    then
      ()
    else
      assert false;
