let rec foldr (x_DO_NOT_CARE_143:bool) (x_DO_NOT_CARE_144:int)
  ...
  if prev_set_flag_foldr_109 then assert false;
  foldr_without_checking_133
    x_DO_NOT_CARE_143 x_DO_NOT_CARE_144 x_DO_NOT_CARE_145
    x_DO_NOT_CARE_146 h_EXPARAM_94 x_DO_NOT_CARE_139 x_DO_NOT_CARE_140
    x_DO_NOT_CARE_141 x_DO_NOT_CARE_142 h x_DO_NOT_CARE_135
    x_DO_NOT_CARE_136 x_DO_NOT_CARE_137 x_DO_NOT_CARE_138 e
    prev_set_flag_foldr_109 s_prev_foldr_h_EXPARAM_105 s_prev_foldr_e_107
    s_prev_foldr_l_108 l
and foldr_without_checking_133 (_:bool) (_:int) (_:int) (_:int)
                              (h_EXPARAM_94:int) (_:bool) (_:int) (_:int)
                              (_:int)
                              (h:(bool ->
                                    int ->
                                      int ->
