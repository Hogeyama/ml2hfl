...
and id_without_checking_254 (_:bool) (_:int) (x:int) =
  let set_flag_id_228 = true
  in
  let s_id_x_225 = x
  in
  x
...
let rec toChurch (_:bool) (_:int) (n:int) (_:bool) (_:int)
                ...
                (s_id_x_225:int) (f:(bool -> int -> int -> int)) =
  if n = 0
  then
    id
  else
    compose
      ...
      (toChurch
        ...
        (0 * f_EXPARAM_114 + (0 * n + 0)) set_flag_id_228 s_id_x_225 
        f)
let main (set_flag_id_228:bool) (s_id_x_225:int) (():unit) =
  let x = Random.int 0
  in
  (if x >= 0
   then
