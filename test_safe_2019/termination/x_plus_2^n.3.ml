...
and g_without_checking_149 (_:bool) (_:int) (_:int) (r_EXPARAM_85:int)
                          ...
                          (_:int) (_:int) (a:int) =
  let set_flag_g_131 = true
  in
  let s_g_a_126 = a
  in
  let s_g_r_EXPARAM_124 = r_EXPARAM_85
  in
  r
...
let main (_:bool) (_:int) (_:int) (n:int) (set_flag_g_131:bool)
        (s_g_r_EXPARAM_124:int) (s_g_a_126:int) (x:int) =
  if n >= 0 && x >= 0
  then
    f
    ...
    0
let u_5702 = main false 0 0 (Random.int 0) false 0 0 (Random.int 0)
