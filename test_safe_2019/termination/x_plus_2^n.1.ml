...
and succ_without_checking_114 (_:bool) (_:int) (n:int) =
  let set_flag_succ_90 = true
  in
  let s_succ_n_87 = n
  in
  n + 1
let g (_:bool) (_:int) (_:int) (_:bool) (_:int)
     ...
     (s_succ_n_87:int) (a:int) =
  r set_flag_succ_90 s_succ_n_87 (r set_flag_succ_90 s_succ_n_87 a)
let rec f (set_flag_succ_90:bool) (s_succ_n_87:int) (n:int) =
  if n = 0
  then
    succ
  else
...
let main (_:bool) (_:int) (n:int) (set_flag_succ_90:bool)
        (s_succ_n_87:int) (x:int) =
  if n >= 0 && x >= 0
  then
    f set_flag_succ_90 s_succ_n_87 n set_flag_succ_90 s_succ_n_87 x
  else
    0
let u_492 = main false 0 (Random.int 0) false 0 (Random.int 0)
