...
let rec g (prev_set_flag_g_198:bool) (u:unit) =
  if prev_set_flag_g_198 then assert false;
  g_without_checking_213 prev_set_flag_g_198 u
and g_without_checking_213 (_:bool) (():unit) =
  let set_flag_g_199 = true
  in
  ()
let rec f (set_flag_g_199:bool) (x:int) =
  if x > 0
  then
    app
    ...
    g
let main (set_flag_g_199:bool) (():unit) =
  f set_flag_g_199 (Random.int 0) set_flag_g_199 ()
let u_42240 = main false ()
