...
and f1_without_checking_350 (_:bool) (_:int) (():unit) (_:bool) (_:int)
                           ...
                           (_:int) (d:unit) =
  let set_flag_f1_293 = true
  in
  let s_f1_c_EXPARAM_285 = c_EXPARAM_282
  in
  d
let f2 (_:bool) (_:int) (u:unit) (_:bool) (_:int) (a_EXPARAM_268:int)
      ...
      (s_f1_c_EXPARAM_285:int) (_:(bool -> int -> unit -> unit)) =
  a
...
let main (set_flag_f1_293:bool) (s_f1_c_EXPARAM_285:int) (u:unit) =
  let zz_1032 =
    f3
      set_flag_f1_293 s_f1_c_EXPARAM_285 u set_flag_f1_293
