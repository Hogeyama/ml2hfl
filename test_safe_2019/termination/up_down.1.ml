...
and up (prev_set_flag_up_93:bool) (s_prev_up_x_92:int) (x:int) =
  if prev_set_flag_up_93 then assert false;
  up_without_checking_120 prev_set_flag_up_93 s_prev_up_x_92 x
...
let main (set_flag_up_94:bool) (s_up_x_91:int) (():unit) =
  ...
  then
    app
      ...
      set_flag_up_94 s_up_x_91 down set_flag_up_94 s_up_x_91 t1
  else
    (if t2 < 0
     then
       app
         set_flag_up_94 s_up_x_91
         (0 * t2 + (0 * t2 + (0 * t1 + (0 * t1 + 0))))
         set_flag_up_94 s_up_x_91 up set_flag_up_94 s_up_x_91 t2)
let u_539 = main false 0 ()
