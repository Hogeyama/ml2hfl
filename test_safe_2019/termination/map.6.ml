  ...
  then
    map
      ...
      (compose
        set_flag_add_300 s_add_x_295 s_add_y_296 (0 * l + (0 * l + 0))
        set_flag_add_300 s_add_x_295 s_add_y_296
        (add set_flag_add_300 s_add_x_295 s_add_y_296 1) set_flag_add_300
        s_add_x_295 s_add_y_296 (0 * l + (0 * l + 0)) set_flag_add_300
        s_add_x_295 s_add_y_296
        (add_without_checking_311
          set_flag_add_300 s_add_x_295 s_add_y_296 2))
      set_flag_add_300 s_add_x_295 s_add_y_296 l
  else
    0
let u_20592 = main false 0 0 ()
