...
and zero_without_checking_525 (_:bool) (_:int) (_:int)
  ...
  let set_flag_zero_513 = true
  in
  let s_zero_z_508 = z
  in
  let s_zero_f_EXPARAM_506 = f_EXPARAM_210
  in
  z
let main (set_flag_zero_513:bool) (s_zero_f_EXPARAM_506:int)
        (s_zero_z_508:int) (():unit) =
  two
