...
and down (prev_set_flag_down_140:bool) (s_prev_down_x_139:int) (x:int) =
  if prev_set_flag_down_140 then assert false;
  down_without_checking_161 prev_set_flag_down_140 s_prev_down_x_139 x
and down_without_checking_161 (_:bool) (_:int) (x:int) =
  ...
  then
    ...
    down_without_checking_161 set_flag_down_141 s_down_x_138 (x - 1)
and up (set_flag_down_141:bool) (s_down_x_138:int) (x:int) =
  if x = 0 then () else up set_flag_down_141 s_down_x_138 (x + 1)
let main (set_flag_down_141:bool) (s_down_x_138:int) (():unit) =
  let t1 = Random.int 0
  in
  let t2 = Random.int 0
  in
  ...
  then
    app
      ...
      set_flag_down_141 s_down_x_138 down set_flag_down_141
      s_down_x_138 t1
  else
    (if t2 < 0
     then
