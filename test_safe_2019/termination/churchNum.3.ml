...
and id_without_checking_382 (_:bool) (_:int) (x:int) =
  let set_flag_id_352 = true
  in
  let s_id_x_349 = x
  in
  x
...
let main (set_flag_id_352:bool) (s_id_x_349:int) (():unit) =
  two
