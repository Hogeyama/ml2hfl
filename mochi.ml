...
let rec arg_spec () =
  Arg.align
    ["-I", Arg.String (fun dir -> Config.load_path := dir::!Config.load_path),
     ...
     "-hors-quickcheck-short", Arg.Unit (fun () -> Flag.Experiment.HORS_quickcheck.(use := Some Shortest)), " Use shortest counterexample generated by hors_quickcheck";
     "-hors-quickcheck-long", Arg.Unit (fun () -> Flag.Experiment.HORS_quickcheck.(use := Some Longest)), " Use longest counterexample generated by hors_quickcheck";
     "-hors-quickcheck-low", Arg.Unit (fun () -> Flag.Experiment.HORS_quickcheck.(use := Some LowestCoverage)), " Use lowest coverage counterexample generated by hors_quickcheck";
     "-hors-quickcheck-high", Arg.Unit (fun () -> Flag.Experiment.HORS_quickcheck.(use := Some HighestCoverage)), " Use highest coverage counterexample generated by hors_quickcheck";
     (* abstraction *)
