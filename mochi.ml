...
let rec arg_spec () =
  Arg.align
    ["-I", Arg.String (fun dir -> Config.load_path := dir::!Config.load_path),
     ...
     "-hors-quickcheck-low", Arg.Unit (fun () -> Flag.Experiment.HORS_quickcheck.(use := LowestCoverage)), " Use lowest coverage counterexample generated by hors_quickcheck";
     "-hors-quickcheck-high", Arg.Unit (fun () -> Flag.Experiment.HORS_quickcheck.(use := HighestCoverage)), " Use highest coverage counterexample generated by hors_quickcheck";
     (* abstraction *)
