...
TEST="intro1.ml intro2.ml intro3.ml sum.ml mult.ml max.ml mc91.ml repeat.ml repeat2.ml fhnhn2.ml lock.ml neg4.ml sum-e.ml mult-e.ml max-e.ml mc91-e.ml repeat-e.ml lock-e.ml"
