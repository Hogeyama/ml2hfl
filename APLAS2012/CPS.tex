...
Programs obtained by their transformation, however, do not yield the
...
each function type is annotated with a label $l \in \{\NC,\IC\}$ like
$\TFunL{l}{\tau_1}{\tau_2}$.
...
\rn{CPS-AppN}.  In the rule \rn{CPS-Prog}, since an application of a
...
\begin{theorem}
Let $D$ be a program. There exists $D'$ such that $\CPSprog{\Gamma}{D}{D'}$.
\end{theorem}
