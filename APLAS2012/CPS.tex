...
\infrule[CPS-Prog]
 {v_i \text{ is of the form } \Abs{x_1}{\Abs{x_2}{\dots\Abs{x_j}{t_i}}} \\
  \Gamma(f_i) \text{ is of the form } \TFunL{l_1}{\tau_{i1}}{\TFunL{l_2}{\tau_{i2}}{\TFunL{l_{j-1}}{\cdots}{\TFunC{\tau_{ij}}{\TFunC{\cdots}{\tau_{ik_i}}}}}} \\
...
(b)
\end{minipage}
\caption{Transformation of $\AbsC{x}{\AbsC{y}{\assert(x =
