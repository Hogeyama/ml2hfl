...
programs.  The reason is that programs obtained by their transformation do not
...
each function type is attached to a label $l \in \{\NC,\IC\}$, like
$\TFunL{l}{\tau_1}{\tau_2}$.
...
transformation.  The relation $\CPS{\Gamma}{t}{\tau}{l}{t'}$ means that
...
\infrule[CPS-Prog]
 {v_i \text{ is of the form } \Abs{x_1}{\Abs{x_2}{\dots\Abs{x_j}{t_i}}} \andalso
  ...
  \Gamma(f_i) \text{ is of the form } \TFunL{l_1}{\tau_{i1}}{\TFunL{l_2}{\tau_{i2}}{\TFunL{l_{k_i-1}}{\cdots}{\TFunC{\tau_{ik_i}}{\tau}}}} \\
...
\CPS{\Gamma}
     ...
     {\Abs{x}{\Abs{y}{\Abs{k}{\App{\App{\assert}{(x=y)}}{k}}}}}
}{
\infer{
 \CPS{\Gamma_x}
     {\Abs{y}{\App{\assert}{(x = y)}}}
     {\TFunC{\INT}{\INT}}{\NC}
     {\Abs{y}{\Abs{k}{\App{\App{\assert}{(x=y)}}{k}}}}
}{
\infer{
 \CPS{\Gamma_{xy}}
     {\App{\assert}{(x = y)}}
     {\INT}{\IC}
     {\Abs{k}{\App{\App{\assert}{(x=y)}}{k}}}
}{
 \CPS{\Gamma_{xy}}{\assert}{\TFunC{\INT}{\INT}}{\NC}{\assert}
  &
...
\infer{
 \CPS{\Gamma}
     ...
     {\Abs{x}{\Abs{k'}{\App{k'}{(\Abs{y}{\Abs{k}{\App{\App{\assert}{(x=y)}}{k}}})}}}}
}{
\infer{
 \CPS{\Gamma_x}
     {\Abs{y}{\App{\assert}{(x = y)}}}
...
$\App{\main}{0} \Reds{D} \FAIL$ if and only if $\App{\App{\main}{0}}{(\Abs{x}{x})} \Reds{D'} \FAIL$.
\end{theorem}
