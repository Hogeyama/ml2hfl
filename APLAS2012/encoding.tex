...
as $\set{(v_1,P_1), \dots, (v_n,P_n)}$ that means that the element is
$v_i$ if $P_i$, a condition for the index, holds.  For example, $\set{(0,\TRUE)}$ denotes that all
...
abstraction for integers, is strictly more powerful than the container
abstraction.
