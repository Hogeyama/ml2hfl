...
\begin{figure}
 ...
 \end{center}
\caption{The verification \cc{framework for} recursive data structures and control operations}
\label{fig:extension}
\end{figure}
...
In this section, we first formalize the encoding of lists. Next, we \cc{argue about} the
