...
\cc{We treat only regular algebraic data types, i.e., the combination of sum
types and product types.  Types of recursive data structures can be represented as
