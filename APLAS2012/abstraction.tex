...
\infrule[A-Prog]
  {\Abst{\Gamma}{E}{v_i}{\Gamma(f_i)}{v_i'} \andalso
   \text{for each $i \in \set{1,\dots,n}$} \andalso \Dom{\Gamma} \cup \Dom{E} = \emptyset}
...
Therefore, one way to decide a function should be in $E$ is to find a
maximal set of the functions that has no cyclic definitions.
