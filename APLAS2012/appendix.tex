...
\infrule[E-Fun]{{(f=v) \in D}}{f \red v}

\infrule[E-Op]
 {\text{$\Denote{\OP}$ is the function denoted by $\OP$}}
 {\Op{v_1,\dots,v_n} \red \Denote{\OP}(v_1,\dots,v_n)}

\infax[E-App]{\App{(\Abs{x}{t_1})}{t_2} \red a}

\infax[E-IfTrue]{\If{\TRUE}{t_1}{t_2} \red t_1}

\infax[E-IfFalse]{\If{\FALSE}{t_1}{t_2} \red t_2}

\infax[E-BrLeft]{\Br{t_1}{t_2} \red t_1}

\infax[E-BrRight]{\Br{t_1}{t_2} \red t_2}

\infrule[E-Context]{t \red t'}{E[t] \red E[t']}

\infax[E-Fail]{E[\FAIL] \red \FAIL}
...
\begin{proof}[Proof of Theorem~\ref{thm:cps_sound}]
