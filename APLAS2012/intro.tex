...
safe.  If not, we check whether the original program is in fact unsafe
...
\end{alltt}
      ...
      precision of abstraction and reduce the number of CEGAR iterations.
