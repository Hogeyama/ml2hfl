...
\end{alltt}
      ...
      \texttt{bx} is true and \texttt{bx} is true denote that
      $\mathtt{x} \geq 0$ and $\mathtt{y} \geq x$, respectively.
...
\end{alltt}
      ...
      abstraction is too coerce.  Automatically finding all such appropriate
      predicates is difficult.  In the previous
