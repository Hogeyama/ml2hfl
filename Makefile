...
CMO = $(addprefix $(OCAML_SOURCE)/utils/,$(OCAML_UTILS_CMO)) \
 ...
 lazy/apronInterface.cmo lazy/csisatInterface.cmo lazy/cvc3Interface.cmo lazy/fdef.cmo lazy/prog.cmo lazy/ctree.cmo lazy/ctreeExpander.cmo lazy/sizType.cmo lazy/trace.cmo lazy/refType.cmo lazy/absType.cmo lazy/verifier.cmo \
 lazyInterface.cmo \
