...
TEST2="mc91 exc-fact fact_notpos isnil mem fold_left forall_eq_pair fold_fun_list"
TEST3="nth0"
TEST4="mult search"
TEST5="nth"
TEST6=""
TEST7="a-copy-print"
TEST8=""
TEST_NOPROGRESS="length harmonic risers iter a-max"
TEST_TOHMC="enc-zip_unzip"
TEST_TOPREDABST="copy_intro enc-zipmap file"
TEST_TOPREDDISC="map_filter fold_right"
...
LIMIT=300
OPTION="-rscomp 0 -popl2015exp -debug 2"
for i in $TEST
do
echo $i
timeout -s 14 $LIMIT ./mochi.opt test/$i.ml $OPTION &> $i.log
echo
done
