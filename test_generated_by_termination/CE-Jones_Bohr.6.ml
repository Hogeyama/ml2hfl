...
let rec f5 (x_DO_NOT_CARE_682:bool) (x_DO_NOT_CARE_683:int) (u:unit)
                  ...
                  int ->
                    bool ->
                      int ->
                        (bool -> int -> unit -> unit) ->
                          bool -> int -> unit -> unit)) =
  if prev_set_flag_f5_664
  then
    if
      (-3) + -s_prev_f5_e_EXPARAM_662 > (-3) + -e_EXPARAM_242 &&
      (-3) + -e_EXPARAM_242 >= 0
    then
      ()
    else
  ...
  f5_without_checking_678
    x_DO_NOT_CARE_682 x_DO_NOT_CARE_683 u x_DO_NOT_CARE_680 x_DO_NOT_CARE_681
    e_EXPARAM_242 prev_set_flag_f5_664 s_prev_f5_e_EXPARAM_662 e
and f5_without_checking_678 (_:bool) (_:int) (u:unit) (_:bool) (_:int)
  ...
  e
    set_flag_f5_665 s_f5_e_EXPARAM_659
    (c2_COEFFICIENT_245 * e_EXPARAM_242 + c1_COEFFICIENT_244) set_flag_f5_665
    s_f5_e_EXPARAM_659 (f4 set_flag_f5_665 s_f5_e_EXPARAM_659 u)
let main (set_flag_f5_665:bool) (s_f5_e_EXPARAM_659:int) (u:unit) =
  let zz_1032 =
    f3
      set_flag_f5_665 s_f5_e_EXPARAM_659 u set_flag_f5_665 s_f5_e_EXPARAM_659
      c0_COEFFICIENT_238 set_flag_f5_665 s_f5_e_EXPARAM_659
      (f5 set_flag_f5_665 s_f5_e_EXPARAM_659 u)
  in
  ()
let u_25187 = main false 0 ()
