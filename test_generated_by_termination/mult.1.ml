let rec mult (x_DO_NOT_CARE_64:bool) (x_DO_NOT_CARE_65:int)
  ...
  if prev_set_flag_mult_50 then assert false;
...
and mult_without_checking_62 (_:bool) (_:int) (_:int) (m:int) (_:bool)
                            (_:int) (_:int) (n:int) =
  ...
  then
    n +
    mult
      set_flag_mult_51 s_mult_m_46 s_mult_n_47 (m - 1) set_flag_mult_51
      s_mult_m_46 s_mult_n_47 n
  else
    0
and u_44 =
  let m = Random.int 0
