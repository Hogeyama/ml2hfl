...
let rec map (x_DO_NOT_CARE_179:bool) (x_DO_NOT_CARE_180:int)
  ...
  if prev_set_flag_map_138
  then
    if s_prev_map_xs_137 > xs && xs >= 0 then () else assert false;
  map_without_checking_174
    x_DO_NOT_CARE_179 x_DO_NOT_CARE_180 x_DO_NOT_CARE_181
    f_EXPARAM_126 x_DO_NOT_CARE_176 x_DO_NOT_CARE_177
    x_DO_NOT_CARE_178 f prev_set_flag_map_138
    s_prev_map_f_EXPARAM_135 s_prev_map_xs_137 xs
and map_without_checking_174 (_:bool) (_:int) (_:int)
                            (f_EXPARAM_126:int) (_:bool) (_:int)
                            (_:int)
...
let compose (_:bool) (_:int) (_:int) (_:int) (_:bool) (_:int) (_:int)
           ...
           (set_flag_map_139:bool) (s_map_f_EXPARAM_132:int)
           (s_map_xs_134:int) (x:int) =
  f
    set_flag_map_139 s_map_f_EXPARAM_132 s_map_xs_134
