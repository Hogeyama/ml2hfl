...
let rec foldr (x_DO_NOT_CARE_142:bool) (x_DO_NOT_CARE_143:int)
  ...
  if prev_set_flag_foldr_108 then assert false;
  foldr_without_checking_132
    x_DO_NOT_CARE_142 x_DO_NOT_CARE_143 x_DO_NOT_CARE_144
    x_DO_NOT_CARE_145 h_EXPARAM_93 x_DO_NOT_CARE_138 x_DO_NOT_CARE_139
    x_DO_NOT_CARE_140 x_DO_NOT_CARE_141 h x_DO_NOT_CARE_134
    x_DO_NOT_CARE_135 x_DO_NOT_CARE_136 x_DO_NOT_CARE_137 e
    prev_set_flag_foldr_108 s_prev_foldr_h_EXPARAM_104 s_prev_foldr_e_106
    s_prev_foldr_l_107 l
and foldr_without_checking_132 (_:bool) (_:int) (_:int) (_:int)
                              (h_EXPARAM_93:int) (_:bool) (_:int) (_:int)
                              (_:int)
                              (h:(bool ->
                                    int ->
                                      int ->
