...
and up (prev_set_flag_up_92:bool) (s_prev_up_x_91:int) (x:int) =
  if prev_set_flag_up_92 then assert false;
  up_without_checking_119 prev_set_flag_up_92 s_prev_up_x_91 x
and up_without_checking_119 (_:bool) (_:int) (x:int) =
  let set_flag_up_93 = true
  in
  let s_up_x_90 = x
  in
  if x = 0 then () else up set_flag_up_93 s_up_x_90 (x + 1)
let main (set_flag_up_93:bool) (s_up_x_90:int) (():unit) =
  ...
  then
    app
      ...
      set_flag_up_93 s_up_x_90 down set_flag_up_93
      s_up_x_90 t1
  else
    (if t2 < 0
     then
       app
         ...
         set_flag_up_93 s_up_x_90 up_without_checking_119
         set_flag_up_93 s_up_x_90 t2)
let u_1962 = main false 0 ()
