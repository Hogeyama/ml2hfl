...
let rec app (x_DO_NOT_CARE_171:bool) (x_DO_NOT_CARE_172:int)
  ...
  then
    if s_prev_app_v_126 > v && v >= 0 then () else assert false;
  app_without_checking_157
    x_DO_NOT_CARE_171 x_DO_NOT_CARE_172 x_DO_NOT_CARE_173
    x_DO_NOT_CARE_174 i x_DO_NOT_CARE_167 x_DO_NOT_CARE_168
    x_DO_NOT_CARE_169 x_DO_NOT_CARE_170 h_EXPARAM_111
    x_DO_NOT_CARE_163 x_DO_NOT_CARE_164 x_DO_NOT_CARE_165
    x_DO_NOT_CARE_166 h x_DO_NOT_CARE_159 x_DO_NOT_CARE_160
    x_DO_NOT_CARE_161 x_DO_NOT_CARE_162 v prev_set_flag_app_128
    s_prev_app_i_123 s_prev_app_h_EXPARAM_124 s_prev_app_v_126 u
and app_without_checking_157 (_:bool) (_:int) (_:int) (_:int) (i:int)
                            (_:bool) (_:int) (_:int) (_:int)
                            (h_EXPARAM_111:int) (_:bool) (_:int)
                            (_:int) (_:int)
                            (h:(bool ->
                                  int ->
                                    int ->
  ...
  then
    app
      ...
      (i - 1) set_flag_app_129 s_app_i_118 s_app_h_EXPARAM_119
      s_app_v_121
...
let rec f (set_flag_app_129:bool) (s_app_i_118:int)
         (s_app_h_EXPARAM_119:int) (s_app_v_121:int) (x:int) =
  if x > 0
  then
    app_without_checking_157
      set_flag_app_129 s_app_i_118 s_app_h_EXPARAM_119 s_app_v_121
    ...
    g
let main (set_flag_app_129:bool) (s_app_i_118:int)
        (s_app_h_EXPARAM_119:int) (s_app_v_121:int) (():unit) =
  f
    set_flag_app_129 s_app_i_118 s_app_h_EXPARAM_119 s_app_v_121
    (Random.int 0) set_flag_app_129 s_app_i_118 s_app_h_EXPARAM_119
    s_app_v_121 ()
let u_16316 = main false 0 0 0 ()
