...
let rec app (x_DO_NOT_CARE_155:bool) (x_DO_NOT_CARE_156:int)
  ...
  if prev_set_flag_app_126
  then
    if s_prev_app_v_124 > v && v >= 0 then () else assert false;
  app_without_checking_147
    x_DO_NOT_CARE_155 x_DO_NOT_CARE_156 x_DO_NOT_CARE_157
    h_EXPARAM_77 x_DO_NOT_CARE_152 x_DO_NOT_CARE_153
    x_DO_NOT_CARE_154 h x_DO_NOT_CARE_149 x_DO_NOT_CARE_150
    x_DO_NOT_CARE_151 v prev_set_flag_app_126
    s_prev_app_h_EXPARAM_122 s_prev_app_v_124 u
and app_without_checking_147 (_:bool) (_:int) (_:int)
                            (h_EXPARAM_77:int) (_:bool) (_:int)
                            (_:int)
                            (h:(bool ->
                                  int ->
                                    int ->
  ...
  in
  h
    set_flag_app_127 s_app_h_EXPARAM_118 s_app_v_120 v
    set_flag_app_127 s_app_h_EXPARAM_118 s_app_v_120 u
