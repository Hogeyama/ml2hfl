...
let rec toChurch (x_DO_NOT_CARE_380:bool) (x_DO_NOT_CARE_381:int)
  ...
  if prev_set_flag_toChurch_360
  then
    if s_prev_toChurch_n_357 > n && n >= 0 then () else assert false;
  toChurch_without_checking_375
    x_DO_NOT_CARE_380 x_DO_NOT_CARE_381 x_DO_NOT_CARE_382 n
    x_DO_NOT_CARE_377 x_DO_NOT_CARE_378 x_DO_NOT_CARE_379
    f_EXPARAM_115 prev_set_flag_toChurch_360 s_prev_toChurch_n_357
...
and toChurch_without_checking_375 (_:bool) (_:int) (_:int) (n:int)
  ...
  then
    ...
    compose
      ...
      set_flag_toChurch_361 s_toChurch_n_354 s_toChurch_f_EXPARAM_355
      f set_flag_toChurch_361 s_toChurch_n_354
      s_toChurch_f_EXPARAM_355
      (c11_COEFFICIENT_125 * f_EXPARAM_115 +
       (c10_COEFFICIENT_124 * n + c9_COEFFICIENT_123))
      set_flag_toChurch_361 s_toChurch_n_354 s_toChurch_f_EXPARAM_355
      (toChurch_without_checking_375
        set_flag_toChurch_361 s_toChurch_n_354
        s_toChurch_f_EXPARAM_355 (n - 1) set_flag_toChurch_361
        s_toChurch_n_354 s_toChurch_f_EXPARAM_355
        (c8_COEFFICIENT_121 * f_EXPARAM_115 +
         (c7_COEFFICIENT_120 * n + c6_COEFFICIENT_119))
        set_flag_toChurch_361 s_toChurch_n_354
        s_toChurch_f_EXPARAM_355 f)
  ...
  (if x >= 0
   then
     let tos =
       toChurch
         set_flag_toChurch_361 s_toChurch_n_354
         s_toChurch_f_EXPARAM_355 x set_flag_toChurch_361
         s_toChurch_n_354 s_toChurch_f_EXPARAM_355
         (c2_COEFFICIENT_113 * x +
          (c1_COEFFICIENT_112 * x + c0_COEFFICIENT_111))
         set_flag_toChurch_361 s_toChurch_n_354
         s_toChurch_f_EXPARAM_355 succ
     in
     ())
let u_16935 = main false 0 0 ()
