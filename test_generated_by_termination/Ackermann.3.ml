let rec ack (x_DO_NOT_CARE_94:bool) (x_DO_NOT_CARE_95:int)
  ...
  then
    if s_prev_ack_n_78 > n && n >= 0 then () else assert false;
  ack_without_checking_92
    x_DO_NOT_CARE_94 x_DO_NOT_CARE_95 x_DO_NOT_CARE_96 m
    prev_set_flag_ack_79 s_prev_ack_m_77 s_prev_ack_n_78 n
  ...
  then
    ...
    then
      ...
      ack_without_checking_92
        ...
        (ack_without_checking_92
          set_flag_ack_80 s_ack_m_75 s_ack_n_76 m set_flag_ack_80
          s_ack_m_75 s_ack_n_76 (n - 1))
let main (set_flag_ack_80:bool) (s_ack_m_75:int) (s_ack_n_76:int)
        (():unit) =
  let m = Random.int 0
  in
  let n = Random.int 0
  ...
  then
    ack
      set_flag_ack_80 s_ack_m_75 s_ack_n_76 m set_flag_ack_80
      s_ack_m_75 s_ack_n_76 n
  else
    0
let u_3344 = main false 0 0 ()
